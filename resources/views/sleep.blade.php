...
<div class="wrap">
  ...
  <p>その為に大事なものが睡眠です</p>
  <p>集中力・思考力・記憶力などの脳のコンディション<br>気分や情動などのメンタルコンディション<br>ホルモンや免疫に関わる身体のコンディション</p>
  <p>この全ての鍵を握っています</p>
    ...
    <div class="main">
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">睡眠時間は人それぞれ</div>
        </div>
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">入眠前は刺激物を避ける</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">眠たくなってから床に就く</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">同じ時刻に毎日起床</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">光の利用で良い睡眠</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">規則正しい食事、運動習慣</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">昼寝は15時前の20〜30分</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">寝酒は不眠のもと</div>
        </div>
        <div class="item_contents">
      ...
      <div class="box">
        ...
        <div class="item_title">
          <div class="sleep_title">日中の眠気が強い時は要注意</div>
        </div>
        <div class="item_contents">
