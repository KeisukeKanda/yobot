...
<div class="wrap">
    ...
    <div class="main">
        <div class="done_date"><p class="date">{{ $result->done_date }}</p></div>
        <div class="result_img"><img src="/result_upload/{{$result->result_file}}" class="img"></div>
        <div class="result_comment"></div>
        <label>自己記録（コメント・メモ）</label>
        <div class="comment_frame"><p class="comment">{{ $result->result_comment }}</p></div>
    </div>
