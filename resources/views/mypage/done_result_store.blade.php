...
<div class="wrap">
    ...
    <div class="main">
        <form enctype="multipart/form-data" action="{{ url('/mypage/done/'.$item->id.'/store') }}" method="POST" class="form-horizontal">
            ...
            <div class="done_date">
                <label>実施年月日</label>
                <div class="date_frame"><input class="" type="text" name="done_date" value=""></div>
                <!--ここにカレンダー-->
            </div>
            ...
            <div class="resule_comment">
                ...
                <div class="comment_frame"><textarea type="text" name="resule_comment" class="comment_area" style="overflow:auto;"></textarea></div>
